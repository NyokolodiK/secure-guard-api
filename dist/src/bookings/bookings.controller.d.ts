...
export declare class BookingsController {
    ...
    findByStatus(status: BookingStatus, user: User): Promise<({
        company: {
            id: string;
            name: string;
            logoUrl: string | null;
    ...
    update(id: string, updateBookingDto: UpdateBookingDto, user: User): Promise<{
        company: {
            id: string;
            name: string;
            email: string;
    ...
    assignGuards(id: string, guardIds: string[], user: User): Promise<{
        company: {
            id: string;
            name: string;
            email: string;
